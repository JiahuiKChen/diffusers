...
comparison_dirs = [
    ("ImageNet_LT_test_30", "cutmix_30"),
    ("ImageNet_LT_test_30", "dropout_30"),
    ("ImageNet_LT_test_30", "embed_cutmix_30"),
    ("ImageNet_LT_test_30", "embed_mixup_30"),
    ("ImageNet_LT_test_30", "mixup_30"),
    ("ImageNet_LT_test_30", "rand_img_cond_30"), 
